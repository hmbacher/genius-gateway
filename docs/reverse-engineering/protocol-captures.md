...
| [:material-download: comissioning-slave.dsl](../assets/downloads/logic-analyzer/comissioning-slave.dsl){ target=_blank } | Interface communication of the radio module that participates in commissioning. | :material-check-bold: | :material-check-bold: | :material-check-bold: |
