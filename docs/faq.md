...
Answers to common questions about the Genius Gateway.

## General Questions

??? info "What is the Genius Gateway?"
    The Genius Gateway is a reverse-engineered interface for Hekatron Genius Plus X smoke detection systems. It monitors RF communications between smoke detectors and provides integration with modern home automation systems through MQTT, web interfaces, and REST APIs.

??? info "Is this an official Hekatron product?"
...
??? info "Is it legal to use this gateway?"
...
??? info "Will this void my smoke detector warranty?"  
...
??? info "Which Hekatron devices are supported?"
...
??? info "How many devices can one gateway monitor?"
...
??? info "What is the range between gateway and smoke detectors?"
...
??? info "Can I use multiple gateways in the same location?"
...
??? info "Do I need special hardware or can I use standard ESP32 boards?"
...
??? info "What WiFi networks are supported?"
...
??? info "Can the gateway work without internet connection?"
...
??? info "What happens if the gateway loses power?"
...
??? info "How do I find the gateway's IP address?"
...
??? info "The gateway isn't discovering my smoke detectors automatically. What should I do?"
...
??? info "How do I integrate with Home Assistant?"
...
??? info "Can I access the gateway remotely over the internet?"
...
??? info "What MQTT broker should I use?"
...
??? info "What MQTT topics does the gateway publish to?"
...
??? info "How often does the gateway publish MQTT updates?"
...
??? info "Can I customize the MQTT topics and payloads?"
...
??? info "The web interface is slow or unresponsive. What should I do?"
...
??? info "I'm getting frequent disconnections from MQTT. How can I fix this?"
...
??? info "The packet visualizer shows no activity even though devices are nearby."
...
??? info "Some devices appear offline even though they're working normally."
...
??? info "How do I update the gateway firmware?"
...
??? info "How do I backup and restore my configuration?"
...
??? info "What maintenance does the gateway require?"
...
??? info "How long do configuration settings persist?"
...
??? info "Does the gateway interfere with smoke detector operation?"
...
??? info "Can the gateway detect all alarms reliably?"
...
??? info "What happens if the gateway fails during an emergency?"
...
??? info "Is the gateway suitable for commercial fire safety applications?"
...
??? info "Can I modify the gateway software for custom features?"
...
??? info "Can I integrate the gateway with other home automation systems besides Home Assistant?"
...
??? info "Are there plans for additional features or device support?"
...
??? info "How can I contribute to the project?"
...
??? info "Can I use this gateway in commercial installations?"
...
??? info "Is professional support available?"
...
??? info "Can I sell products based on this design?"
